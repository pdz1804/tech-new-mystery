...
$secretPayload = [ordered]@{
  ...
  LANGFUSE_SECRET_KEY = Get-EnvValue "LANGFUSE_SECRET_KEY"
  LANGFUSE_PUBLIC_KEY = Get-EnvValue "LANGFUSE_PUBLIC_KEY"
  LANGFUSE_BASE_URL = Get-EnvValue "LANGFUSE_BASE_URL"
  LANGSMITH_API_KEY = Get-EnvValue "LANGSMITH_API_KEY"
  ELEVENLABS_API_KEY = Get-EnvValue "ELEVENLABS_API_KEY"
  ELEVENLABS_VOICE_ID = Get-EnvValue "ELEVENLABS_VOICE_ID"
  LIVEKIT_API_KEY = Get-EnvValue "LIVEKIT_API_KEY"
  LIVEKIT_API_SECRET = Get-EnvValue "LIVEKIT_API_SECRET"
}
