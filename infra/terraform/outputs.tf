# DISABLED outputs — references to ECS/ALB/Redis/Clustering resources
# Uncomment each block when re-enabling those services
...
# ============================================================================
# CLUSTERING INFRASTRUCTURE OUTPUTS (disabled with clustering.tf)
# ============================================================================
