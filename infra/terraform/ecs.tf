...
locals {
  ...
  backend_environment = [
    ...
    { name = "AGENT_CORE_RUNTIME_ARN", value = aws_bedrockagentcore_agent_runtime.agent_core.agent_runtime_arn },
    { name = "AGENT_CORE_REQUIRE_TRUE_STREAMING", value = "true" },
    { name = "LANGSMITH_TRACING", value = "true" },
    { name = "LANGSMITH_ENDPOINT", value = "https://api.smith.langchain.com" },
    { name = "LANGSMITH_PROJECT", value = "tech-news-voice" },
    { name = "ELEVENLABS_STT_MODEL_ID", value = "scribe_v2_realtime" },
    { name = "ELEVENLABS_STT_AUDIO_FORMAT", value = "pcm_16000" },
    { name = "ELEVENLABS_TTS_MODEL_ID", value = "eleven_flash_v2_5" },
    { name = "ELEVENLABS_TTS_OUTPUT_FORMAT", value = "mp3_44100_128" },
  ...
  backend_secrets = [
    ...
    { name = "LANGSMITH_API_KEY", valueFrom = "${local.app_secret_arn}:${var.secret_json_keys.langsmith_api_key}::" },
    { name = "ELEVENLABS_API_KEY", valueFrom = "${local.app_secret_arn}:${var.secret_json_keys.elevenlabs_api_key}::" },
